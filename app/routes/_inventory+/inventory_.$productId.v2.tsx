...
export default function ProductRoute() {
	...
	return (
		<>
				...
				<div className="flex flex-col items-center justify-between gap-4 sm:flex-row md:justify-normal">
					<div className="flex gap-4">
						<Button
							...
							asChild
						>
							<LinkWithParams preserveSearch unstable_viewTransition to=".." relative="path">
			...
			<div onClick={() => navigator.clipboard.writeText('Just copied This!')}>
				DONT
				<Button variant={"destructive"} asChild>
					<Link to={"v2"} unstable_viewTransition>GO TO V2</Link>
				</Button>
			</div>
