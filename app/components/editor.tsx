...
import { type action } from '#app/routes/_inventory+/inventory.edit.tsx'
			...
			<Dialog open={open} onOpenChange={setOpen}>
				...
				<DialogContent className="sm:max-w-3xl">
					...
					<div className="flex items-center justify-between gap-3">
						<div className="flex w-full items-center justify-center gap-3 break-all rounded-md border bg-accent p-3 font-semibold text-muted-foreground">
						...
						<div className="flex w-full grow items-center justify-center gap-3 break-all rounded-md border bg-accent p-3 font-semibold text-muted-foreground">
							<div className="flex flex-col items-center gap-3">
								<Icon name={icon} className="shrink-0 text-3xl" />
								<div className="flex flex-col">
									<span className="text-center uppercase text-foreground ">
